...
<html>
	...
	<head>	
		...
		<script type="text/javascript" src="dwr/interface/menuServicio.js"></script> 
	   <script type="text/javascript" src="js/soporte/gruposMenuCatalogo.js"></script>

	</head>
<body>
<div id="contenedorForma">
<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="grupos">
<fieldset class="ui-widget ui-widget-content ui-corner-all">		
	<legend class="ui-widget ui-widget-header ui-corner-all">Grupos del Menú</legend>						
	...
	<tr>
		   ...
		   <td >
			 	<form:input id="menu" name="menu" path="menu" size="7" tabindex="2"/>	 	
				<input type="text" id="nombreMenu" name="nombreMenu" size="30" tabindex="3" disabled="true"/>
			</td>					
		</tr>
