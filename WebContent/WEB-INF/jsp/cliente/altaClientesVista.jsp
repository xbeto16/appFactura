...
<html>
	<head>
		<script type="text/javascript" src="dwr/interface/clienteServicio.js"></script>
      	<script type="text/javascript" src="js/cliente/altaCliente.js"></script>
	</head>
	<body>
		<div id="contenedorForma">
			<form:form id="formaGenerica" name="formaGenerica" method="POST" commandName="clienteBean">
				<fieldset class="ui-widget ui-widget-content ui-corner-all">
					<legend class="ui-widget ui-widget-content ui-widget-header ui-corner-all">Alta Cliente</legend>
					<table border="0" cellpadding="0" cellspacing="5" width="100%">
						<tr>
							...
							<td>
								<form:input type="text" id="clienteID" name="clienteID" path="clienteID" size="5" onkeypress="" tabindex="1"/>
							</td>
